...
// ══════════════════════════════════════════════
// SETTINGS catalog — Global, Tickets, Assets, Workflows, Integrations
// ══════════════════════════════════════════════
export const SETTINGS_SECTIONS: PermissionSection[] = [
  ...
  },
  {
    ...
    perms: [
      ...
      { id: 'stk-scheduled-tickets', label: 'Scheduled Tickets', description: 'Controls visibility and management of scheduled/recurring tickets', controlType: 'segment', segmentOptions: ['Hide', 'View', 'Manage'] },
      ...
      { id: 'stk-topics', label: 'Topics', description: 'Controls visibility and management of topic definitions. Topics determine ticket routing and form assignment', controlType: 'segment', segmentOptions: ['Hide', 'View', 'Manage'], subGroup: 'Topics Manager' },
      { id: 'stk-success-messages', label: 'Success Messages', description: 'Controls visibility and management of automatic confirmation messages sent after ticket submission', controlType: 'segment', segmentOptions: ['Hide', 'View', 'Manage'], subGroup: 'Topics Manager' },
    ],
  },
  {
    id: 'assets',
  ...
  },
  {
    ...
    perms: [
      { id: 'wf-workflows', label: 'Workflows', description: 'Controls visibility and management of workflow automation rules for tickets and assets', controlType: 'segment', segmentOptions: ['Hide', 'View', 'Manage'] },
  ...
  },
  {
    ...
    icon: 'apps',
    perms: [
      { id: 'in-fee-catalogue', label: 'Fee Catalogue', description: 'Controls visibility and management of the SchoolCash fee catalogue, including adding, editing, and deactivating fees per department.', controlType: 'segment', segmentOptions: ['Hide', 'View', 'Manage'], subGroup: 'SchoolCash' },
      { id: 'in-parts-catalogue', label: 'Parts Catalogue', description: 'Controls visibility and management of the SchoolCash parts catalogue used for fee-bearing repair and replacement charges.', controlType: 'segment', segmentOptions: ['Hide', 'View', 'Manage'], subGroup: 'SchoolCash' },
    ],
  },
];
...
export const ROLE_PRESET_STATES: Record<string, RolePresetState> = {
  'Global Admin': {
    ...
    segments: {
      ...
      'gl-activity-log': 'View', 'gl-ai-training-resources': 'Manage', 'gl-chatbot': 'Edit',
      'gl-cx-score-templates': 'Manage', 'gl-email': 'Edit', 'gl-response-templates': 'Manage',
      'gl-field-library': 'Manage', 'gl-visibility-rules': 'Edit', 'gl-keyword-alerts': 'Manage',
      'gl-languages': 'Edit', 'gl-live-agents': 'Edit', 'gl-portal-branding': 'Edit',
      'gl-global-locations': 'Manage', 'gl-department-locations': 'Manage', 'gl-tags-tickets': 'Manage', 'gl-tags-assets': 'Manage',
      'stk-portals-it-service': 'Manage', 'stk-portals-landing-page': 'Manage', 'stk-forms': 'Manage',
      ...
      'wf-workflows': 'Manage', 'wf-lookup-tables': 'Manage',
      'in-fee-catalogue': 'Manage', 'in-parts-catalogue': 'Manage',
    },
  },
  'Global User': {
    ticketScope: 'all',
    ...
    segments: {
      ...
      'gl-activity-log': 'Hide', 'gl-ai-training-resources': 'Hide', 'gl-chatbot': 'Hide',
      'gl-cx-score-templates': 'Hide', 'gl-email': 'Hide', 'gl-response-templates': 'Hide',
      'gl-field-library': 'Hide', 'gl-visibility-rules': 'Hide', 'gl-keyword-alerts': 'Hide',
      'gl-languages': 'Hide', 'gl-live-agents': 'Hide', 'gl-portal-branding': 'Hide',
      'gl-global-locations': 'Hide', 'gl-department-locations': 'Hide',
      'gl-tags-tickets': 'Manage', 'gl-tags-assets': 'Hide',
      'stk-portals-it-service': 'Hide', 'stk-portals-landing-page': 'Hide', 'stk-forms': 'Hide',
      ...
      'wf-workflows': 'Hide', 'wf-lookup-tables': 'Hide',
      'in-fee-catalogue': 'Hide', 'in-parts-catalogue': 'Hide',
    },
  },
  'Team Member': {
  ...
  'Read Only': {
    ...
    segments: {
      ...
      'cp-campaigns': 'Hide', 'cp-contacts': 'Hide', 'cp-campaign-templates': 'Hide',
      'gl-activity-log': 'View', 'gl-ai-training-resources': 'View', 'gl-chatbot': 'View',
      'gl-cx-score-templates': 'View', 'gl-email': 'View', 'gl-response-templates': 'View',
      'gl-field-library': 'View', 'gl-visibility-rules': 'View', 'gl-keyword-alerts': 'View',
      'gl-languages': 'View', 'gl-live-agents': 'View', 'gl-portal-branding': 'View',
      'gl-global-locations': 'View', 'gl-department-locations': 'View', 'gl-tags-tickets': 'View', 'gl-tags-assets': 'View',
      'stk-portals-it-service': 'View', 'stk-portals-landing-page': 'View', 'stk-forms': 'View',
      ...
      'wf-workflows': 'View', 'wf-lookup-tables': 'View',
      'in-fee-catalogue': 'View', 'in-parts-catalogue': 'View',
    },
  },
};
