...
export class App implements AfterViewInit, OnDestroy {
  ...
  settingsExpanded: Record<string, boolean> = {
    ...
    'locations': false,
    'portal-branding': false,
    'service-portals': false,
  ...
  private readonly _settingsItems: SettingsItem[] = [
    ...
    { id: 'portal-branding',        label: 'Portal Branding',        section: 'global',           isSubheader: true },
    { id: 'portal-branding-tickets', label: 'Tickets',               section: 'global',           subheaderParent: 'portal-branding' },
    { id: 'portal-branding-assets', label: 'Assets',                 section: 'global',           subheaderParent: 'portal-branding' },
    ...
    // Tickets Settings
    { id: 'service-portals',        label: 'Service Portals',        section: 'tickets-settings', isSubheader: true },
    { id: 'service-portals-landing-page', label: 'Landing Page / Tab', section: 'tickets-settings', subheaderParent: 'service-portals' },
    { id: 'service-portals-systems', label: 'Systems',               section: 'tickets-settings', subheaderParent: 'service-portals' },
